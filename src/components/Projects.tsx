...
const projects = [
  ...
  { 
    id: 2, 
    title: 'MarketInsight', 
    category: 'AI Stock Analysis Agent', 
    color: 'from-emerald-500/30 to-teal-500/30',
    description: 'LangGraph-based ReAct agent providing real-time insights with multi-step reasoning.',
    tech: 'LangChain, LangGraph, LLaMA 3, Flask',
  ...
  { 
    ...
    description: 'Content-based recommendation engine using TF-IDF & Bag of Words for personalized movies.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {projects.map((p, i) => (
            <motion.div
              ...
              className="group relative aspect-[4/5] md:aspect-[4/3] rounded-[2rem] overflow-hidden cursor-pointer bg-black/50"
            >
              {/* Background Image */}
              <Image 
                src={p.image} 
