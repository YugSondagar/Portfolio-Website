...
const experiences = [
  {
    ...
    role: 'Retrieval Augmented Generation (RAG) with LangChain',
    date: '2026',
    bullets: [
      'Completed industry-grade training on RAG pipelines using LangChain.',
      'Gained hands-on experience integrating LLMs with external data sources.'
    ]
  },
  {
  ...
  },
  {
    ...
    date: '2025',
    bullets: [
      'Completed Cloud Foundations certification focusing on AWS core services.',
      'Learned best practices for scalable and secure cloud architectures.'
    ]
  },
  {
    company: 'Deloitte',
